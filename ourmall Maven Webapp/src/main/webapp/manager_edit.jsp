                ...
                <form class="form-horizontal">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" value="asdfghjkl">
                      </div>
                    </div>
					          <div class="form-group">
                      <label class="col-sm-3 control-label">电话</label>
                      <div class="col-sm-6">
                        <input type="text" class="form-control" value="16678909876">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  <div class="box-footer">
          					...
          					<div class="col-sm-6">
                              <button type="submit" class="col-sm-2 btn btn-info">保存</button>
          					</div>
                  </div><!-- /.box-footer -->
                </form>
              </div><!-- /.box -->

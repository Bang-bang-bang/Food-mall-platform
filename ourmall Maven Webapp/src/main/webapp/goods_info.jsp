                    ...
                    <table id="example1" class="table table-hover">
                      <thead>
                        <tr>
                          ...
                          <th>销售价格</th>
                          <th>生产日期</th>
                          <th><a href="goods_upload.html"><button class="btn btn-info btn-sm"><i class="fa fa-plus"></i></button></a></th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          ...
                          <td><a href="goods_edit.html">编辑</a></td>
                        </tr>
                        <tr>
                          <td><input type="checkbox"></td>
                          <td>002</td>

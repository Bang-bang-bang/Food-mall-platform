...
<html>
  ...
  <body class="hold-transition skin-yellow sidebar-mini">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="goods_info.html"><i class="fa fa-circle-o"></i> 商品信息管理</a></li>
                ...
                <form class="form-horizontal">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <textarea class="form-control" rows="3">台湾进口优之良品 芒果味双层布丁285g</textarea>
                      </div>
                    </div>
					          <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" value="中国台湾">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control pull-right" id="reservation" value="09/11/2016-10/23/2016">
                      </div>
                    </div>
					          <div class="form-group">
    ...
    <div class="daterangepicker dropdown-menu show-calendar opensleft" style="display: none;">
          ...
          <table class="table-condensed">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="available active start-date end-date" data-title="r2c4">15</td>
      ...
      <div class="ranges">
        <div class="range_inputs">
          ...
          <div class="daterangepicker_end_input">
            <label for="daterangepicker_end">至</label>
            <input class="input-mini" type="text" name="daterangepicker_end" value="">
          </div>
          <button class="applyBtn btn btn-small btn-sm btn-info">确定</button>&nbsp;<button class="cancelBtn btn btn-small btn-sm btn-default">取消</button>
        </div>
      </div>
    </div>
  </body>
